                                                ...
                                                <table id="tabel-proyek" height="50px" class="table table-bordered">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th style="text-align: center" width="5%">ID voucher</th>
                                                            <th style="text-align: center" width="5%">ID Produk</th>
                                                            <th style="text-align: center" width="30%">Kode Voucher</th>
                                                            <th style="text-align: center" width="25%">Nama Proyek</th>
                                                            <th style="text-align: center" width="30%">Tgl Klaim</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        serverSide: true, 
        ajax: {
            "url": "<?php echo base_url('api/getTabelProduk')?>",
            "type": "POST",
            data: function(data){
