                          ...
                          <div class="row">
                              <div class="col-md-6">
                                  ...
                                  <select id="filter_kategori" name="kategori" class="form-control" onchange="">
                                      ...
                                      <option value="A">Wilayah</option>
                                      <option value="B">Kab/Kota</option>
                                  </select>
                              </div>
                              <div class="col-md-6">
                                  <label> Filtering Provinsi </label>
                                  <select class="select2-provinsi required" style="width: 100%;" id="kategori" name="kategori" onchange="getInfoBahan($(this).val())">
                                      <option value=""></option>
                                  </select>
