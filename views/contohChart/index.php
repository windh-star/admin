                                    ...
                                    <table id="tabel-ahs" class="table table-striped table-bordered">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="text-align: center" width="20%">ID Bahan</th>
                                                ...
                                                <th style="text-align: center" width="13%">Tahun</th>
                                                <th style="text-align: center" width="13%">Sumber</th>
                                                <th style="text-align: center" width="13%">Keterangan</th>
                                                <th>ID Proyek Bahan</th>
                                                <th>ID Pekerjaan Proyek</th>
...
<script type="text/javascript">
  ...
  var tabel,tabel_bahan_terpakai;
  $(document).ready(function() {
      ...
      $('#tabel-ahs tbody').on('click', 'td.details-control', function () {
        ...
        var data = row.data();
        var id_proyekbahan = data[13];
        var id_proyekproyek = data[14];
        var bahan = data[5];
