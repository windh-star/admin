                                                ...
                                                <table id="tabel-proyek" height="50px" class="table table-bordered">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th style="text-align: center" width="5%">ID Kategori</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        $('#menu_template').click();
        $('#menu_template_kategori_pekerjaan').prop('class','active');
        ...
        serverSide: true, 
        ajax: {
            "url": "<?php echo base_url('api/getTabelTemplateKategoriPekerjaan')?>",
            "type": "POST",
            data: function(data){
