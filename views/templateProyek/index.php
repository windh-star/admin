                                                ...
                                                <table id="tabel-proyek" height="50px" class="table table-bordered">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th style="text-align: center" width="5%">ID Template</th>
                                                            <th style="text-align: center" width="30%">Nama Proyek</th>
                                                            <th style="text-align: center" width="25%">Jenis Proyek</th>
                                                            <th style="text-align: center" width="30%">Kategori Proyek</th>
                                                            <th style="text-align: center" width="10%">Jasa Kontraktor</th>
                                                            <th style="text-align: center" width="10%">Pajak</th>
                                                            <th style="text-align: center" width="10%">Status</th>
                                                            <th style="text-align: center" width="10%">Foto Proyek</th>
                                                            <th style="text-align: center" width="10%">Tgl Dibuat</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        $('#menu_template').click();
        $('#menu_template_proyek').prop('class','active');
        ...
        serverSide: true, 
        ajax: {
            "url": "<?php echo base_url('api/getTabelTemplateProyek')?>",
            "type": "POST",
            data: function(data){
