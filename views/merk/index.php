                      ...
                      <div class="panel-heading">
                          <h3 class="panel-title">TABEL KATEGORI PEKERJAAN</h3>
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <br><br>
                                            <table id="tabel-kategori-produk" height="50px" class="table table-striped table-bordered">
                                                <thead>
                                                    <tr>
                                                        <th style="text-align: center" width="3%">No.</th>
                                                        <th style="text-align: center" width="10%">ID Merk</th>
                                                        <th style="text-align: center" width="30%">Merk</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $(".select2-proyek").select2({
            ...
            ajax: {
                url: "<?php echo base_url() ?>api/getTabelKategoriProduk",
                dataType: 'json',
                delay: 250,
        ...
        ///Datatable kategori
        tabel = $("#tabel-kategori-produk").DataTable({
            "language": {
            ...
            serverSide: true,
            ajax: {
              "url": "<?php echo base_url('api/getTabelMerk') ?>",
              "type": "POST",
              data: function (data) {
                data.produk = $('#kategori-produk').val();
              }
            },
            order: [1, 'asc'],
            "bInfo": false,
        ...
        ///reload data 
        $('#kategori-produk').on('change', function() {
          reloadData();
        });
        ///end reload
