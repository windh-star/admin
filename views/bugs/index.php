                ...
                <div class="col-md-6">
                  <div class="panel panel-default">
                      ...
                      <div class="panel-body">
                          <div class="row">
                              <div class="col-md-6">
                              <label> Filtering Rentang Tanggal </label>
                        ...
                        <div class="panel-body">
                                      ...
                                      <div class="panel-body">
                                          <ul class="list-group">
                                              <li class="list-group-item">
                                                  <span class="badge badge-warning" id="jum_artike" style="font-size:10pt; font-weight: bold;">0</span>
                                                  Artikel
                                              </li>
                                              <li class="list-group-item">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <table id="tabel-bugs" class="table table-striped table-bordered" style="width: 100%">
                                        <thead>
                                            <tr>
