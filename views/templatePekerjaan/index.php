                                                ...
                                                <table id="tabel-proyek" height="50px" class="table table-bordered">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th style="text-align: center" width="10%">ID Template</th>
                                                            ...
                                                            <th style="text-align: center" width="15%">Jam Dibuat</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        $('#menu_template').click();
        $('#menu_template_pekerjaan').prop('class','active');
        ...
        serverSide: true, 
        ajax: {
            "url": "<?php echo base_url('api/getTabelTemplatePekerjaan')?>",
            "type": "POST",
            data: function(data){
