...
class AlatTerpakaiModel extends CI_Model {
  public $tabel = "alat";
  ...
  function getTabelAlatTerpakai($datatable){
      $columns = implode(', ', $datatable['col-display']);
...
//   }
  ...
  function getRincianBahanTerpakai($id_proyekbahan,$id_proyekproyek,$alat){
    return $this->db->query("SELECT ahs.id_ahs,alat.id_proyek as id_proyekbahan,proyek.id_proyek as id_proyekproyek, 
    ahs.id_proyek,ahs.nama_pekerjaan,proyek.nama_proyek,alat.nama_alat 
    FROM ahs,alat,proyek 
    WHERE ahs.id_proyek='{$id_proyekbahan}' and ahs.id_proyek='{$id_proyekproyek}' and alat.nama_alat='{$alat}' group by nama_pekerjaan");
   }
   ...
   function getRincianJumlahBahanTerpakai($id_proyekbahan,$id_proyekproyek,$bahan){
    ...
    FROM ahs,alat,proyek 
    WHERE ahs.id_proyek='{$id_proyekbahan}' and ahs.id_proyek='{$id_proyekproyek}' and alat.nama_alat='{$alat}' ");
   }
