...
class RatingProdukModel extends CI_Model{
    public $tabel = "rating_produk";

    function getTabelRatingProduk($datatable){
      $columns = implode(', ', $datatable['col-display']);
      $query  = "(SELECT rating_produk.id_rating,produk.nama_produk, pengguna.nama_pengguna,rating_produk.rating,rating_produk.ulasan,rating_produk.tgl_dibuat,rating_produk.jam_dibuat FROM rating_produk,produk,pengguna WHERE rating_produk.id_produk=produk.id_produk AND rating_produk.id_pengguna=pengguna.id_pengguna) a";
