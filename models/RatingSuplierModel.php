...
class RatingSuplierModel extends CI_Model{
    public $tabel = "rating_suplier";

    function getTabelRatingSuplier($datatable){
      $columns = implode(', ', $datatable['col-display']);
      $query  = "(SELECT rating_suplier.id_rating,rating_suplier.id_suplier, pengguna.nama_pengguna,rating_suplier.rating,rating_suplier.ulasan,rating_suplier.tgl_dibuat,rating_suplier.jam_dibuat FROM rating_suplier,pengguna WHERE rating_suplier.id_pengguna=pengguna.id_pengguna) a";
