...
class TemplatePekerjaanModel extends CI_Model{
    public $tabel = "template_pekerjaan";

    function getTabelTemplatePekerjaan($datatable){
      $columns = implode(', ', $datatable['col-display']);
      $query  = "(SELECT * FROM template_pekerjaan) a";
