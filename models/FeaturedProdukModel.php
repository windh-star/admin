...
class FeaturedProdukModel extends CI_Model{
    public $tabel = "featured_produk";

    function getTabelFeaturedProduk($datatable){
      $columns = implode(', ', $datatable['col-display']);
      $query  = "(SELECT featured_produk.*,produk.nama_produk FROM featured_produk,produk WHERE featured_produk.id_produk=produk.id_produk) a";
